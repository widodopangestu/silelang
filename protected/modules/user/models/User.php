...
class User extends CActiveRecord {
    ...
    public function rules() {
        ...
        return ((get_class(Yii::app()) == 'CConsoleApplication' || (get_class(Yii::app()) != 'CConsoleApplication' && Yii::app()->getModule('user')->isAdmin())) ? array(
                    ...
                    array('superuser, status, departement_id, organization_id', 'numerical', 'integerOnly' => true),
                    array('id, username, password, email, activkey, create_at, lastvisit, superuser, status, created, updated, departement_id, organization_id', 'safe', 'on' => 'search'),
    ...
    public function relations() {
        ...
        $rel = array(
            'completionReviews' => array(self::HAS_MANY, 'CompletionReview', 'user_id'),
            'invoiceReviews' => array(self::HAS_MANY, 'InvoiceReview', 'user_id'),
            'notifications' => array(self::HAS_MANY, 'Notification', 'user_id'),
            'paymentDocuments' => array(self::HAS_MANY, 'PaymentDocument', 'user_id'),
            'profile' => array(self::HAS_ONE, 'Profile', 'user_id'),
            'projects' => array(self::HAS_MANY, 'Project', 'user_id'),
            'proposals' => array(self::HAS_MANY, 'Proposal', 'user_id'),
            'proposalComments' => array(self::HAS_MANY, 'ProposalComment', 'user_id'),
            'torReviews' => array(self::HAS_MANY, 'TorReview', 'user_id'),
    ...
    public function defaultScope() {
        return CMap::mergeArray(Yii::app()->getModule('user')->defaultScope, array(
                    'alias' => 'user',
                    'select' => 'user.id, user.username, user.email, user.create_at, user.lastvisit, user.superuser, user.status, user.created, user.updated, user.departement_id, user.organization_id',
                ));
    }
