...
class PaymentDocumentController extends Controller {
    ...
    public function actionCreate() {
        $model = new PaymentDocument;
        $model->termin_id = $this->_termin->id;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['PaymentDocument'])) {
            $model->attributes = $_POST['PaymentDocument'];
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('PaymentDocument', array(
                    'criteria' => array(
    ...
    public function actionAdmin() {
        $model = new PaymentDocument('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['PaymentDocument']))
            $model->attributes = $_GET['PaymentDocument'];
    ...
    public function loadModel($id) {
        $model = PaymentDocument::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'payment-document-form') {
